        ...
        <div class="row">
            ...
            <div class="col-md-9 account">
                <div class="row">
                    ...
                    <div class="clearfix"></div>
                    <div class="col-md-6">
                        <form class="info-account" action="{{ URL::to('/update-info') }}" method="POST" role="form">
                            @csrf
                            <div class="form-group">
                                <input type="text" value="{{ $customer->name }}" class="form-control" name="fullname"
                                    placeholder="Họ và tên" required=""
                                    oninvalid="this.setCustomValidity('Vui lòng nhập tên của bạn')"
                                    oninput="this.setCustomValidity('')">
                            </div>
                            <div class="form-group">
                                <input type="tel" value="{{ $customer->mobile }}" class="form-control" name="mobile"
